...
function TopicForm({setResult,setLoading,loading,setError}) {
  ...
  return (
    ...
    >
      <input
        type="text"
        className="w-full p-3 rounded-3xl bg-white/10 backdrop-blur-lg border border-white/20 placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-white/30"
