  ...
  return (
    <div className="min-h-screen bg-gray-100 px-6 py-10 relative">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <PricingCard onClick={handlePaying}
          title="Starter"
          price="₹100"
          amount={100}
          credits="50 Credits"
...
function PricingCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className={`relative cursor-pointer rounded-2xl p-6 bg-white border transition ${isSelected ? "border-black" : popular ? "border-indigo-500" : "border-gray-200"}`}
    >
      {popular && !isSelected && (
