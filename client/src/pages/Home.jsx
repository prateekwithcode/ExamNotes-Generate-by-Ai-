  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black">
      ...
      <section className="max-w-7xl mx-auto px-8 pt-32 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          <div className="overflow-hidden">
            <img src={img1} alt="img" style={{transform:"translateZ(35px)"}} />
          </div>
      ...
      <section className="max-w-6xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-4 gap-10">
        <Features icon="📘" title="Exam Notes" desc="High-yield exam-oriented notes with revision points."/>
        <Features icon="📁" title="Project Notes" desc="Well-Structured content for assignments and projects."/>
        <Features icon="📊" title="Diagrams" desc="Auto-generated visual diagrams for clarity."/>
        <Features icon="⬇" title="PDF Download" desc="Download clean, printable PDFs instantly."/>
      </section>
